...
/**
 * Creates a form to create Warpwire media entities from within Media Library.
 */
class WarpwireMediaLibraryAddForm extends AddFormBase
{

    public function getFormId()
    {
        return 'warpwire_media_library_add';
    }
